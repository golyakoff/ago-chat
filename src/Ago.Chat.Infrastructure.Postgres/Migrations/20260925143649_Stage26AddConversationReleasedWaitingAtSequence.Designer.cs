...
namespace Ago.Chat.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260925143649_Stage26AddConversationReleasedWaitingAtSequence")]
    partial class Stage26AddConversationReleasedWaitingAtSequence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ago.Chat.Domain.AcceptanceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SubjectKind", "SubjectId", "AcceptedAt")
                        .HasDatabaseName("ix_acceptance_records_subject");

                    b.ToTable("acceptance_records", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Domain.AiAddOnEnablement", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");

                    b.Property<string>("AcceptedDocumentKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("accepted_document_key");

                    b.Property<string>("AcceptedDocumentVersion")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("accepted_document_version");
                    ...
                    b.ToTable("ai_add_on_enablements", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Domain.AiProcessingBasisDeclaration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SiteId", "DeclaredAt")
                        .HasDatabaseName("ix_ai_basis_declarations_site");

                    b.ToTable("ai_processing_basis_declarations", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.BillingSubscription", b =>
                {
                    ...
                    b.Property<int>("AdminExtraPriceVersion")
                        .HasColumnType("integer")
                        .HasColumnName("admin_extra_price_version");

                    b.Property<int>("BaseSeatPriceVersion")
                        .HasColumnType("integer")
                        .HasColumnName("base_seat_price_version");
                    ...
                    b.Property<int>("ExtraAdministratorsPurchased")
                        .HasColumnType("integer")
                        .HasColumnName("extra_administrators_purchased");

                    b.Property<int>("ExtraSeatPriceVersion")
                        .HasColumnType("integer")
                        .HasColumnName("extra_seat_price_version");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.Conversation", b =>
                {
                    ...
                    b.Property<long>("AttachmentBytesReserved")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("attachment_bytes_reserved");

                    b.Property<DateTimeOffset?>("AttachmentUploadGrantedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("attachment_upload_granted_at");

                    b.Property<Guid?>("AttachmentUploadGrantedBy")
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ErasureRecordId")
                        .HasColumnType("uuid")
                        .HasColumnName("erasure_record_id");

                    b.Property<DateTimeOffset?>("ErasureRequestedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("erasure_requested_at");

                    b.Property<Guid?>("ErasureRequestedBy")
                        .HasColumnType("uuid")
                        .HasColumnName("erasure_requested_by");
                    ...
                    b.Property<int?>("ReleasedWaitingAtSequence")
                        .HasColumnType("integer")
                        .HasColumnName("released_waiting_at_sequence");

                    b.Property<DateTimeOffset?>("RoutingSuppressedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("routing_suppressed_at");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.ConversationAssignmentInterval", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ConversationId")
                        .IsUnique()
                        .HasDatabaseName("ix_conversation_assignments_open")
                        .HasFilter("ended_at IS NULL");

                    b.HasIndex("SiteId");

                    b.HasIndex("OperatorId", "StartedAt")
                        .HasDatabaseName("ix_conversation_assignments_operator_started");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.DownloadOverageCharge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<long>("BytesOver")
                        .HasColumnType("bigint")
                        .HasColumnName("bytes_over");
                    ...
                    b.HasIndex("SiteId", "PeriodMonth")
                        .HasDatabaseName("ix_download_overage_charges_site_id_period_month");

                    b.ToTable("download_overage_charges", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.EnabledModule", b =>
                {
                    ...
                    b.Property<bool>("GrantedByOwner")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("granted_by_owner");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.ModuleQuantityGrant", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");
                    ...
                    b.Property<DateTimeOffset?>("UnconditionalGrantExpiresAt")
                        .HasColumnType("timestamptz")
                        .HasColumnName("unconditional_grant_expires_at");

                    b.Property<string>("UnconditionalGrantReason")
                        .HasColumnType("text")
                        .HasColumnName("unconditional_grant_reason");

                    b.Property<DateTimeOffset?>("UnconditionalGrantSetAt")
                        .HasColumnType("timestamptz")
                        .HasColumnName("unconditional_grant_set_at");

                    b.Property<string>("UnconditionalGrantSetBy")
                        .HasColumnType("text")
                        .HasColumnName("unconditional_grant_set_by");

                    b.Property<bool>("UnconditionallyGrantedByOwner")
                        .HasColumnType("boolean")
                        .HasColumnName("unconditionally_granted_by_owner");

                    b.HasKey("SiteId", "ModuleKey");

                    b.ToTable("module_quantity_grants", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Domain.ModuleQuantityImpactPreview", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");
                    ...
                    b.Property<string>("AffectedItemDisplayNames")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("affected_item_display_names");
                    ...
                    b.ToTable("module_quantity_impact_previews", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.OperatorDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.OperatorInvite", b =>
                {
                    ...
                    b.Property<string>("SendFailureCode")
                        .HasColumnType("text")
                        .HasColumnName("send_failure_code");
                    ...
                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_operator_invites_site_id");

                    b.ToTable("operator_invites", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Domain.OwnerSeatGrant", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");
                    ...
                    b.HasKey("SiteId", "Role");

                    b.ToTable("owner_seat_grants", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.PricedResource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Key")
                        .IsUnique()
                        .HasDatabaseName("ix_priced_resources_key");

                    b.ToTable("priced_resources", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.PublishedPriceVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("PricedResourceId")
                        .HasColumnType("uuid")
                        .HasColumnName("priced_resource_id");
                    ...
                    b.HasIndex("PricedResourceId");

                    b.HasIndex("Key", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("ix_published_price_versions_key_sequence");

                    b.ToTable("published_price_versions", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.Site", b =>
                {
                    ...
                    b.Property<bool>("DownloadBlockExempt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<string>("DownloadOverageBillingMode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                    ...
                    b.Property<DateTimeOffset?>("DownloadOverageBillingModeChangedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("download_overage_billing_mode_changed_at");

                    b.Property<string>("DownloadOverageBillingModeChangedBy")
                        .HasColumnType("text")
                        .HasColumnName("download_overage_billing_mode_changed_by");

                    b.Property<string>("DownloadOverageBillingModeReason")
                        .HasColumnType("text")
                        .HasColumnName("download_overage_billing_mode_reason");
                    ...
                    b.Property<DateTimeOffset?>("InactivityWarningSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("inactivity_warning_sent_at");

                    b.Property<DateTimeOffset?>("LastOperatorActivityAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_operator_activity_at");

                    b.Property<string>("LastRefusedOrigin")
                        .HasColumnType("text")
                        .HasColumnName("last_refused_origin");

                    b.Property<DateTimeOffset?>("LastRefusedOriginAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_refused_origin_at");
                    ...
                    b.Property<int>("TeamChatLastSequence")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("team_chat_last_sequence");
                    ...
                    b.Property<bool>("_acceptUnverifiedPhone")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("widget_accept_unverified_phone");

                    b.Property<bool>("_allowAttachmentUploadsByDefault")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<bool>("_attractAttention")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("widget_attract_attention");

                    b.Property<int>("_autoOpenDelaySeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30)
                        .HasColumnName("widget_auto_open_delay_seconds");

                    b.Property<bool>("_autoOpenEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("widget_auto_open_enabled");

                    b.Property<string>("_autoOpenGreetingText")
                        .HasColumnType("text")
                        .HasColumnName("widget_auto_open_greeting_text");

                    b.Property<string>("_brandCompanyName")
                        .HasColumnType("text")
                        .HasColumnName("brand_company_name");

                    b.Property<string>("_cannedResponses")
                        .HasColumnType("text")
                        .HasColumnName("canned_responses");

                    b.Property<string>("_channelSwitcherIconSize")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                    ...
                    b.Property<string>("_channelSwitcherPlacement")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("AboveComposer")
                        .HasColumnName("widget_channel_switcher_placement");

                    b.Property<string>("_contactCaptureConfirmationText")
                        .HasColumnType("text")
                    ...
                    b.Property<string>("_logoObjectKey")
                        .HasColumnType("text")
                        .HasColumnName("logo_object_key");

                    b.Property<string>("_logoRejectionReason")
                        .HasColumnType("text")
                        .HasColumnName("logo_rejection_reason");

                    b.Property<string>("_logoStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                    ...
                    b.Property<string>("_panelTitle")
                        .HasColumnType("text")
                        .HasColumnName("widget_panel_title");

                    b.Property<string>("_pendingLogoObjectKey")
                        .HasColumnType("text")
                        .HasColumnName("pending_logo_object_key");
                    ...
                    b.HasIndex("LastOperatorActivityAt")
                        .HasDatabaseName("ix_sites_inactivity_watchdog")
                        .HasFilter("erasure_requested_at is null");

                    b.HasIndex("SuspendedUntil")
                        .HasDatabaseName("ix_sites_suspended_until")
                        .HasFilter("suspended_until IS NOT NULL");

                    b.ToTable("sites", null, t =>
                        {
                            t.HasCheckConstraint("ck_sites_channel_switcher_icon_size", "widget_channel_switcher_icon_size IN ('Large', 'Medium', 'Small')");

                            t.HasCheckConstraint("ck_sites_channel_switcher_placement", "widget_channel_switcher_placement IN ('AboveComposer', 'BelowLauncher')");
                            ...
                            t.HasCheckConstraint("ck_sites_widget_auto_open_delay", "widget_auto_open_delay_seconds IN (15, 30, 45, 60, 90, 120)");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.TeamMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<bool>("AuthorIsAdmin")
                        .HasColumnType("boolean")
                        .HasColumnName("author_is_admin");

                    b.Property<Guid>("AuthorOperatorId")
                        .HasColumnType("uuid")
                        .HasColumnName("author_operator_id");
                    ...
                    b.HasIndex("AuthorOperatorId");

                    b.HasIndex("SiteId", "ClientMessageId")
                        .IsUnique()
                        .HasDatabaseName("ix_team_messages_site_client_message_id")
                        .HasFilter("client_message_id is not null");

                    b.HasIndex("SiteId", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("ix_team_messages_site_sequence");
            ...
            modelBuilder.Entity("Ago.Chat.Domain.Visitor", b =>
                {
                    ...
                    b.Property<string>("EmojiCreature")
                        .HasColumnType("text")
                        .HasColumnName("emoji_creature");

                    b.Property<string>("EmojiFood")
                        .HasColumnType("text")
                        .HasColumnName("emoji_food");
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.AccessRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.ContactCarryoverRequestEntity", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");
                    ...
                    b.Property<Guid?>("CursorContactId")
                        .HasColumnType("uuid")
                        .HasColumnName("cursor_contact_id");
                    ...
                    b.HasIndex("CompletedAt", "RequestedAt")
                        .HasDatabaseName("ix_contact_carryover_requests_pending");

                    b.ToTable("contact_carryover_requests", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.ContactRevealEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("ContactDetailId")
                        .HasColumnType("uuid")
                        .HasColumnName("contact_detail_id");
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.ConversationBlockRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("conversation_block_records", null, t =>
                        {
                            t.HasCheckConstraint("ck_conversation_block_records_kind", "kind IN ('Blocked', 'Unblocked')");
                        });
                });
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.ErasureRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<int>("AttachmentsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("attachments_deleted");

                    b.Property<DateTimeOffset?>("CompletedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("completed_at");

                    b.Property<int>("ContactDetailsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("contact_details_deleted");

                    b.Property<int>("ConversationsMarkedForErasure")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("conversations_marked_for_erasure");

                    b.Property<string>("FailureReason")
                        .HasColumnType("text")
                        .HasColumnName("failure_reason");

                    b.Property<int>("IdentitiesDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("identities_deleted");

                    b.Property<int>("MessagesDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("messages_deleted");

                    b.Property<int>("NotesDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("notes_deleted");
                    ...
                    b.Property<int>("StorageObjectsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("storage_objects_deleted");

                    b.Property<int>("TagsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("tags_deleted");

                    b.Property<int>("VisitorRestrictionsDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("visitor_restrictions_deleted");

                    b.HasKey("Id");

                    b.ToTable("erasure_records", null, t =>
                        {
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.OperatorSeatRestoreOverrideEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_operator_seat_restore_overrides_site_id");

                    b.ToTable("operator_seat_restore_overrides", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.RolePermissionRemovalOverrideEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_role_permission_removal_overrides_site_id");

                    b.ToTable("role_permission_removal_overrides", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.SiteSuspensionRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("SiteId", "PerformedAt")
                        .HasDatabaseName("ix_site_suspensions_site_id_performed_at");

                    b.ToTable("site_suspensions", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.SiteWidgetActivityEntity", b =>
                {
                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");
                    ...
                    b.ToTable("site_widget_activity", (string)null);
                });

            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.TeamMessageRemovalEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("RemovedByOperatorId")
                        .HasColumnType("uuid")
                        .HasColumnName("removed_by_operator_id");

                    b.Property<Guid>("SiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("site_id");

                    b.Property<Guid>("TeamMessageId")
                        .HasColumnType("uuid")
                        .HasColumnName("team_message_id");

                    b.HasKey("Id");

                    b.HasIndex("RemovedByOperatorId");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_team_message_removals_site_id");

                    b.HasIndex("TeamMessageId")
                        .IsUnique()
                        .HasDatabaseName("ix_team_message_removals_team_message_id");

                    b.ToTable("team_message_removals", (string)null);
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.PublishedPriceVersion", b =>
                {
                    b.HasOne("Ago.Chat.Domain.PricedResource", null)
                        .WithMany("_versions")
                        .HasForeignKey("PricedResourceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Ago.Chat.Domain.TeamMessage", b =>
                {
                    b.HasOne("Ago.Chat.Domain.Operator", null)
                        .WithMany()
                        .HasForeignKey("AuthorOperatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.TeamMessageRemovalEntity", b =>
                {
                    b.HasOne("Ago.Chat.Domain.Operator", null)
                        .WithMany()
                        .HasForeignKey("RemovedByOperatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Ago.Chat.Domain.TeamMessage", null)
                        .WithMany()
