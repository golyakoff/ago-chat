...
namespace Ago.Chat.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260907122240_Stage23AddConversationAttachmentBudget")]
    partial class Stage23AddConversationAttachmentBudget
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("access_records", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_access_records_resource_kind", "resource_kind IS NULL OR resource_kind IN ('Conversation', 'ChannelIdentity', 'EnabledModule')");
                        });
                });
