...
namespace Ago.Chat.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260913181453_Stage23AddUnconditionalModuleQuantityGrant")]
    partial class Stage23AddUnconditionalModuleQuantityGrant
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ago.Chat.Infrastructure.Postgres.Persistence.AccessRecordEntity", b =>
                {
                    ...
                    b.ToTable("access_records", null, t =>
                        {
                            t.HasCheckConstraint("ck_access_records_access_kind", "access_kind IN ('CrossConversationHistoryRead', 'OwnerSiteList', 'OwnerSiteDetail', 'OwnerModuleGrant', 'OwnerModuleRevoke', 'OwnerChannelIdentityUnlink', 'OwnerModuleQuantityGrant', 'OwnerOperatorSeatRestore')");

                            t.HasCheckConstraint("ck_access_records_actor_kind", "actor_kind IN ('Operator', 'PlatformOwner')");

                            t.HasCheckConstraint("ck_access_records_resource_kind", "resource_kind IS NULL OR resource_kind IN ('Conversation', 'ChannelIdentity', 'EnabledModule', 'ModuleQuantityGrant', 'Operator')");
                        });
                });
