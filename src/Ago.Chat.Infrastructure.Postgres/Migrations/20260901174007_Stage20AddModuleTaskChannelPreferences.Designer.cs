...
namespace Ago.Chat.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260901174007_Stage20AddModuleTaskChannelPreferences")]
    partial class Stage20AddModuleTaskChannelPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ago.Chat.Domain.Message", b =>
                {
                    ...
                    b.HasIndex("ConversationId", "ClientMessageId", "CreatedAt", "RetentionClass")
                        .IsUnique()
                        .HasFilter("client_message_id IS NOT NULL");

                    b.HasIndex("ConversationId", "Sequence", "CreatedAt", "RetentionClass")
                        .IsUnique();
