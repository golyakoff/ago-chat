...
///
/// <para><b>`adr/0184`: no contact carry-over any more.</b> `23-59` made a grant also request a
/// retroactive copy of every contact into the granted module; that copy is deleted with `adr/0147`'s
/// replication, so a grant is exactly what it says - a grant.</para>
/// </summary>
