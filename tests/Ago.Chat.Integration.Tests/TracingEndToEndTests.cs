...
public sealed class TracingEndToEndTests(ConnectionFanoutFixture fixture)
{
    ...
    public async Task SendingOneMessage_ProducesOneTraceId_SpanningHubThroughDelivery()
    {
        ...
        var batchWriter = new MessageBatchWriter(fixture.DataSource, new SystemClock(), new UuidV7Generator(), new NoOpCache(), Options.Create(new SiteActivityWatchdogOptions()), NullLogger<MessageBatchWriter>.Instance);
