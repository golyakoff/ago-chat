...
/// <summary>`23-88`: the identical hand-written-fake shape
/// <see cref="Ago.Chat.Application.Tests.Fakes.FakeModuleQuantityGrantStore"/> establishes for its own
/// sibling port, over <see cref="ModuleQuantityImpactPreview"/> instead of
